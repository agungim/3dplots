...
class Wave_Packet:
    def __init__(self, n_points, dt, sigma0=5.0, k0=1.0, x0=-150.0, x_begin=-200.0,
        ...
        self.psi = self.psi * sp.exp(1.0j * k0 * self.x)
        self.psi = self.psi * (2.0 * sp.pi * sigma0**2)**(-0.25)
...
wave_packet = Wave_Packet(n_points=500, dt=0.5, barrier_width=15, barrier_height=0.5)
